<template>
	<header
		class="header header-5"
		:class="mobile_menu ? 'none' : ''"
		style="position: fixed; background-color: black"
	>
		<div class="sticky-wrapper" style="height: 63.5px">
			<div class="header-middle sticky-header" style="padding-right: 0px">
				<div class="container-fluid">
					<div class="header-left">
						<button class="mobile-menu-toggler" @click="openMenu()">
						...
						<nav class="main-nav">
							<ul
								class="menu sf-arrows sf-js-enabled"
							...
							>
								...
								<li>
									<a ref="shop" class="sf-with-ul"
										>Shop</a
									>

									<div
										ref="shop_menu"
										class="megamenu megamenu-md"
										style="display: none; width: 300px; left: 0; text-align: center"
										
									>
										<div class="row no-gutters">
											<div class="col-md-9" style="text-align: center; max-width: 100%; margin-left: 30%">
												<div class="menu-col">
													<div class="row">
														<div class="col-md-6">
															<div
	...
	<!-- End .header -->
	<div :class="mobile_menu ? 'mmenu-active mobile-menu-container' : 'mobile-menu-container'">
        <div class="mobile-menu-wrapper">
            <span class="mobile-menu-close" @click="closeMenu()"><i class="icon-close"></i></span>
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <router-link to="/products">Shop<span class="mmenu-btn"></span></router-link>
                        <ul>
	...
	export default {
		...
		mounted: function(){
			...
			shop.addEventListener('mouseenter', () => {
				this.$refs.shop_menu.style.display = 'block'
			})
			this.$refs.shop_menu.addEventListener('mouseenter', () => {
				this.$refs.shop_menu.style.display = 'block'
			})
			this.$refs.shop_menu.addEventListener('mouseleave', () => {
				this.$refs.shop_menu.style.display = 'none'
			})
		},
		components: {
			SearchBar,
		...
		methods: {
			displayDropdown: function () {
				this.pages_dropdown = true;
			},
			removeDropdown: function () {
				this.pages_dropdown = false;
			},
			closeMenu: function(){
